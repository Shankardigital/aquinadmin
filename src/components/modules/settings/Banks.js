...
function Banks() {
  ...
  const getCategory = () => {
    ...
    axios
      .get(
        "https://aquinapi.aquin.us/api/v1/admin/bankname/getallbanknames",
  ...
  const updateCategory = () => {
    ...
    axios
      .put(
        "https://aquinapi.aquin.us/api/v1/admin/bankname/editbankname" +
          "/" +
          data1,
        user1,
        {
  ...
  const deleteUser = (data) => {
    ...
    axios
      .delete(
        "https://aquinapi.aquin.us/api/v1/admin/bankname/removebankname" +
          "/" +
          data1,
        {
          headers: { Authorization: `Bearer ${token}` },
  ...
  const handlechanged = (e) => {
    ...
    axios
      .get(
        `https://aquinapi.aquin.us/api/v1/admin/bankname/getallbanknames?title=${e.target.value}`,
      ...
      <Box sx={{ display: "flex" }} className="mainn">
        ...
        <Box component="main" sx={{ flexGrow: 2, p: 4 }}>
          <Breadcrumbs aria-label="breadcrumb" style={{ paddingTop: "70px" }}>
            ...
            ,<Typography color="text.primary">Bank List</Typography>
          </Breadcrumbs>
          <React.Fragment>
