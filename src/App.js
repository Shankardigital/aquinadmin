...
import Payouts from "./components/modules/Reports/Payouts";
import Withdrawreport from "./components/modules/Reports/Withdrawreport";
import 'bootstrap/dist/css/bootstrap.min.css';
import Payments from "./components/modules/Payments/Payments";
import MakePayment from "./components/modules/ewallet/MakePayment";
import Earnings from "./components/modules/ewallet/Earnings";
import Membersview from "./components/modules/Members/Membersview";
import Memberedit from "./components/modules/Members/Memberedit";
import Qrcode from "./components/modules/settings/Qrcode";

import Changepass from  "./components/sign in/Changepas";
import Otp from  "./components/sign in/Otp";
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/Walletreport" element={<Payouts />} />
          <Route path="/Withdrawreport" element={<Payouts />} />
          ...
          <Route path="/wallet-coins" element={<Earning />} />
