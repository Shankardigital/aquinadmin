...
function Makepayments() {
  ...
  const getCategory = () => {
    ...
    axios
      .post(
        "https://aquinapi.aquin.us/api/v1/admin/txfercoin/getalltxcointoMember",
        {},
  ...
  const Transfercoin = () => {
    ...
    const params = {
      txMemberUser_id: userdata,
      RxMemberUser_id: form.RxMemberUser_id,
      admincoins: parseInt(form.admincoins),
    };
    axios
      .post(
        "https://aquinapi.aquin.us/api/v1/admin/txfercoin/txcointoMember",
        params,
  ...
  const handlechange = (e) => {
    ...
    axios
      .post(
        `https://aquinapi.aquin.us/api/v1/admin/txfercoin/getalltxcointoMember?searchQueryParams=${e.target.value}`,
        {},
      ...
      <Box sx={{ display: "flex" }} className="mainn">
        ...
        <Box component="main" sx={{ flexGrow: 2, p: 4 }}>
          <Breadcrumbs aria-label="breadcrumb" style={{ paddingTop: "70px" }}>
            ...
            ,<Typography color="text.primary">Transfer Coins</Typography>
          </Breadcrumbs>
          <React.Fragment>
                  ...
                  {user0.userCoinInfo == null ? (
                    ...
                    <>
                      ...
                      >
                        ...
                        <label className="mt-3">Coins</label>
                        <input
                          type="text"
                          className="form-control"
